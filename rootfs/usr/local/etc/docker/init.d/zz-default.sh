...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
ETC_DIR="/etc/coolify"     # set etc directory
CONF_DIR="/config/coolify" # set config directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
RUN_DIR="/run/init.d"        # set scripts pid dir
LOG_DIR="/data/logs/coolify" # set log directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
root_user_name="${COOLIFY_ROOT_USER_NAME:-}" # root user name
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# passwords [password/random]
user_pass="${COOLIFY_USER_PASS_WORD:-}"      # normal user password
root_user_pass="${COOLIFY_ROOT_PASS_WORD:-}" # root user password
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
APPLICATION_FILES="$LOG_DIR/coolify.log"
