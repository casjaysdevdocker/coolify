...
ARG IMAGE_REPO="casjaysdevdocker/coolify"
...
LABEL org.opencontainers.image.url="https://docker.io/casjaysdevdocker/coolify"
LABEL org.opencontainers.image.source="https://docker.io/casjaysdevdocker/coolify"
